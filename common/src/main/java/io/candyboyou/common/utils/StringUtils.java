...
public class StringUtils {
    ...
    private static final Pattern MOBILE_PATTERN =  Pattern.compile("[\\s-]"); //手机号过滤正则,空格或者连字符-
    ...
    public static String patternMobile(String mobile) {
        ...
        return MOBILE_PATTERN.matcher(mobile).replaceAll(EMPTY);
    }
    ...
    public static String join(String separator, String... collection) {
        if (collection == null) {
            return null;
        }
        StringBuilder sb = new StringBuilder();
